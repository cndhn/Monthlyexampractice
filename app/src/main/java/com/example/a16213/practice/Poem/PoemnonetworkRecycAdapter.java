...
public class PoemnonetworkRecycAdapter extends RecyclerView.Adapter<PoemnonetworkRecycAdapter.MyHolder>{

    List<PoemInfo> list = new ArrayList <>();

    public void refresh(List<PoemInfo> list){
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i) {
        ...
        myHolder.writer.setText("诗词作者:"+list.get(i).getWriter());
